 ...
 */
class Version20170214164348 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE acl_users (id INT AUTO_INCREMENT NOT NULL, primary_email_id INT DEFAULT NULL, username VARCHAR(64) NOT NULL, firstname VARCHAR(64) DEFAULT NULL, lastname VARCHAR(64) NOT NULL, salt VARCHAR(255) DEFAULT NULL, password VARCHAR(255) NOT NULL, is_active TINYINT(1) NOT NULL, is_expired TINYINT(1) NOT NULL, is_locked TINYINT(1) NOT NULL, is_credentials_expired TINYINT(1) NOT NULL, expires_at DATETIME DEFAULT NULL, credentials_expire_at DATETIME DEFAULT NULL, password_token VARCHAR(32) DEFAULT NULL, api_key VARCHAR(64) DEFAULT NULL, api_key_expires_at DATETIME DEFAULT NULL, last_login_at DATETIME DEFAULT NULL, created_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_901AE856F85E0677 (username), UNIQUE INDEX UNIQ_901AE856894DAC38 (primary_email_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE acl_organisations (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(64) NOT NULL, description LONGTEXT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
